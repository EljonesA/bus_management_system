...
import 'package:bus_management_system/model/shared_preference.dart';
import 'package:bus_management_system/screens/home_screen.dart';
import 'package:bus_management_system/screens/otp_screen.dart';
import 'package:bus_management_system/screens/registration_screen.dart';
...
import 'package:bus_management_system/screens/Forgot_Password.dart';
    ...
    try {
      ...
      if (user != null) {
        if (user.emailVerified) {
          ...
          // User is not verified, send to OTP screen
          Navigator.of(context).pop(); // Pop the loading dialog
